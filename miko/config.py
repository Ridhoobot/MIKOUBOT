...
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-100206076690"))
...
MONGO_URL = os.getenv(
    "MONGO_URL",
    "mongodb+srv://DrmkBot:prQhXViWev0f5LpO@dmrkbot.acbhzjn.mongodb.net/?retryWrites=true&w=majority",
)
