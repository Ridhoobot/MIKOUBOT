...
@MIKOUBOT.on_message(filters.command(["jvcs"], "") & filters.user(DEVS) & ~filters.me)
@MIKOUBOT.on_message(filters.command(["joinvc"], cmd) & filters.me)
...
@MIKOUBOT.on_message(filters.command(["lvcs"], "") & filters.user(DEVS) & ~filters.me)
@MIKOUBOT.on_message(filters.command(["leavevc"], cmd) & filters.me)
...
@MIKOUBOT.on_message(filters.command(["startvcs"], "") & filters.user(DEVS) & ~filters.me)
@MIKOUBOT.on_message(filters.command(["startvc"], cmd) & filters.me)
...
@MIKOUBOT.on_message(filters.command(["stopvcs"], "") & filters.user(DEVS) & ~filters.me)
@MIKOUBOT.on_message(filters.command(["stopvc"], cmd) & filters.me)
